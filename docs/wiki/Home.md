...
- [Troubleshooting](Troubleshooting.md): common fixes for setup, market data, stock splits, imports, and display issues.
...
- Manual market-price overrides for temporary quote repairs
